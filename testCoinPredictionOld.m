function [prediction] = testCoinPredictionCache(imageDir, datasetFile, cnn, softmaxTheta, convolutionsStepSize, maxTestSamples, maxTopPredictions)
...
[pred] = netPredict(X, cnn, softmaxTheta, convolutionsStepSize, maxTopPredictions);
