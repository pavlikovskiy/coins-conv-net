function [prediction, mlp_confidence] = netPredictSoftmax(X, cnn, Theta3, maxTopPredictions)
...
[prediction, mlp_confidence] = softmaxPredict(Theta3, X, maxTopPredictions);
